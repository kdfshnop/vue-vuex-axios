            ...
            <el-row>
                <el-col :span="12">
                    ...
                    <el-form-item label="代理商所属城市">                        
                        ...
                        <territory v-model="agentCity" :startLevel='2' :endLevel="3" :placeholder="'请输入城市名'"></territory>
                    </el-form-item>  
                </el-col>
                <el-col :span="12">  
...
export default {
    ...
    methods: {
        ...
        handleComplete() {
            ...
            console.log(this.innerItem,'innerItem更改，编辑完成调用了')                                        
    ...
    computed: {
        ...
        agentCityStr() {
            ...
            // 以上是1.0;
            return this.$store.state.AgentBasicInfo.agentCity;
        },
        remote() {
