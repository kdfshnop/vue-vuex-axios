        ...
        <el-form ref="form" :model="item" label-width= "180px" v-show="mode === 'create' || mode === 'edit' && status === 'editing'">
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="上传汇款凭证" v-show="paymentStatus">
                        <upload multiple v-if="mode === 'create' || mode === 'edit' && status === 'editing'" :fileList.sync="fileList"></upload>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
            ...
            <!-- <template > -->
                ...
                <el-form-item label="承诺支付书" v-if="!paymentStatus">
                    <upload v-if="mode === 'create' || mode === 'edit' && status === 'editing'" :fileList.sync="promiseFileList" multiple></upload>
                </el-form-item>
            <!-- </template> -->
