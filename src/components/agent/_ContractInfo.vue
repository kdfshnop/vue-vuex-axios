    ...
    <CollapsePanel class="gap-2" :expand="expand">
        ...
        <el-form ref="form" :model="item" label-width= "180px" v-show="mode === 'create' || mode === 'edit' && status === 'editing'">
            <el-form-item label="上传合同">
                <upload :fileList.sync="contractFileList" v-if="mode === 'create' || mode === 'edit' && status === 'editing'" multiple></upload>
            </el-form-item>
            ...
            <el-form-item label="承诺书上传">
                    <upload multiple :fileList.sync="promiseFileList" v-if="mode === 'create' || mode === 'edit' && status === 'editing'"></upload>
            </el-form-item>
        </el-form>
