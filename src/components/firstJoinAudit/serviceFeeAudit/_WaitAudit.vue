    ...
    <div>
        ...
        <el-table :data="waitAuditList" border style="width: 100%">
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    <el-button size="mini" @click="audit(scope.$index, scope.row)" type="text" v-show="privileges.serviceFeeAudit">审核</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    data(){
        return {
            privilegeOption: {//权限控制
                "serviceFeeAudit": "/serviceFeeAuditResult#serviceFeeAudit"
            },
