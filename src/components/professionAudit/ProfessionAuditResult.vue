...
import WaitAudit from '@/components/professionAudit/_WaitAudit';
import AuditNoPass from '@/components/professionAudit/_AuditNoPass';
import AuditPass from '@/components/professionAudit/_AuditPass';
...
export default {
    ...
    data(){
        return {
            breadCrumb: [{text:'业务审核'},{text: "编辑审核"}],
            wait:true,
            reject:false,
            pass:false,
            total:{}
