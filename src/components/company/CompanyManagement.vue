            ...
            <el-form ref="form" :model="form" label-width="180px" class="gap" label-position="right">
                <el-row>
                    <el-col :span="12">
                        ...
                        <el-form-item label="公司所属城市" prop="areaInfo">
...
export default {
    ...
    components:{EditorCompany,Commission,BreadCrumb,Region,Territory},
    ...
    methods:{
        ...
        requestList(){
            ...
            delete realForm.areaInfo;//删除表单中的areaInfo选项，因为提交数据时不需要该参数
